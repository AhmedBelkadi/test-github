...
//    }
    ...
    public function index()
    {
        ...
        // Fetch all emploi_du_temps records along with related filiere and semestre
        $emploises = EmploiDuTemps::with(['filiere', 'semestre', 'seances'])->paginate(1);

        // Organize the schedule data
        $schedule = [];
...
//        dd($schedule);
        ...
        return view("admin.emplois.index", compact("periodes", "days", "schedule", "emploises"));
    }
