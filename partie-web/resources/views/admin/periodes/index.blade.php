    ...
    <div>
        <form method="post" action="{{ isset($p) ? route("periodes.update", $p) : route("periodes.store") }}" class="">
            ...
            <div class="  d-flex justify-content-between align-items-center" >
                <div class="row w-100">
                    <div class="col ">
                        <input type="text" name="libelle" id="libelleBasic" class="form-control-lg  form-control" placeholder="Enter Name" value="{{ isset($p) ? $p->libelle : old("libelle") }}"/>
        ...
        @foreach( $periodes as $p )
            <div class="d-flex justify-content-center mb-2" >
                ...
                <a  href="{{route("periodes.edit",[ 'periode'=>$p , 'openModal2' => true])}}" class="btn btn-primary text-white  btn-lg" >
