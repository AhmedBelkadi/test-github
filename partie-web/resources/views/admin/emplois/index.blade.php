...
{{--        @if(isset($emplois))--}}
{{--                @foreach( $emploises as $schedule )--}}

{{--                    <div class="container">--}}
{{--                        <h2 class="mt-4 mb-4">@if(isset($schedule)) {{$schedule->filiere->name}} @endif</h2>--}}
...
{{--                                    @foreach ($periodes as $periode)--}}
{{--                                        <td>--}}
{{--                                            @if (isset($schedule[$day][$periode->id]))--}}
{{--                                                @foreach ($schedule[$day][$periode->id] as $session)--}}
                                ...
                                <td>
                                    @if (isset($schedule[$emploi->filiere->name][$emploi->semestre->name][$day][$periode->id]))
                                        @foreach ($schedule[$emploi->filiere->name][$emploi->semestre->name][$day][$periode->id] as $seance)
                                            <button type="button" class="btn btn-primary">{{ $seance->element->name }}</button>
                                            ...
                                            <button type="button" class="btn btn-primary">
                                                ...
                                                @endforeach
                                            <button type="button" class="btn btn-primary">{{ $seance->type }}</button>
                                            <button type="button" class="btn btn-primary">{{ $seance->salle->name }}</button>
                                        @endforeach
                                    @else
                                        <button type="button" class="btn btn-primary add-session" data-toggle="modal" data-target="#exampleModal">+</button>
                                    @endif
